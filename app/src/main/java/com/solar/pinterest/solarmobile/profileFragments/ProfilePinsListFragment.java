...
public class ProfilePinsListFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        dataForPins.createDataList(getArguments().getStringArrayList(URL_KEY), getArguments().getStringArrayList(TITLE_KEY), getArguments().getIntegerArrayList(ID_KEY));
    }
